...
// var n:number=100
// var index:number=0
// var evenNum:number=n/2
// var formula:number=evenNum+1
// while (index<1) {
//     console.log((formula)*(evenNum))
//     index++
// }
// // 8. Write a ts program to find sum of all odd numbers between 1 to n.
// var n:number=100
// var index:number=0
// var oddNum:number=n/2
// while (index<1) {
...
// var nu10:number[]=[56847]
// var num10:any=nu10.toString()
// var numb10:any=num10.split("")
// var number:any=numb10.map(Number)
// console.log(number.length)
// // 11. Write a ts program to find first and last digit of a number.
// var num11:number[]=[56783]
// var numb11:any=num10.toString().split("")
// var nu11:number=numb10.map(Number)
// console.log(nu11[0],"first digit of number")
// console.log(nu11[4],"first digit of number")
// 12. Write a ts program to find sum of first and last digit of a number.
// var num12:number[]=[56783]
// var numb12:any=num12.toString().split("")
// var nu12:number=numb12.map(Number)
// var sumOfNum:number=nu12[0]+nu12[4]
// console.log("sum of first and last digit of number is",sumOfNum)
// 13. Write a ts program to swap first and last digits of a number.
// var nu13:number[]=[12456]
// var num13:any=nu13.toString().split("")
// var numb13:any=num13.map(Number)
// numb13.splice(0,1,6)
// numb13.splice(4,1,1)
// console.log(numb13)
...
var num16 = [145782];
console.log(num16.reverse);
// var numb16:any=num16.toString().split("")
// var number16:any=num16.map(Number).reverse
